...
{for(var i = 0, len = gdjs.evtsExt__ButtonStates__ButtonAnimationName.ButtonAnimationName.prototype.SetIdleAnimationNameContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__ButtonStates__ButtonAnimationName.ButtonAnimationName.prototype.SetIdleAnimationNameContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._setIdleAnimationName(eventsFunctionContext.getArgument("Value"));
}
}}
...
{for(var i = 0, len = gdjs.evtsExt__ButtonStates__ButtonAnimationName.ButtonAnimationName.prototype.SetFocusedAnimationNameContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__ButtonStates__ButtonAnimationName.ButtonAnimationName.prototype.SetFocusedAnimationNameContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._setFocusedAnimationName(eventsFunctionContext.getArgument("Value"));
}
}}
...
{for(var i = 0, len = gdjs.evtsExt__ButtonStates__ButtonAnimationName.ButtonAnimationName.prototype.SetPressedAnimationNameContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__ButtonStates__ButtonAnimationName.ButtonAnimationName.prototype.SetPressedAnimationNameContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._setPressedAnimationName(eventsFunctionContext.getArgument("Value"));
}
}}
